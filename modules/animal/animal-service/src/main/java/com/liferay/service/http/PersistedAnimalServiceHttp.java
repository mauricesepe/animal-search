...
public class PersistedAnimalServiceHttp {
	...
	public static com.liferay.model.PersistedAnimal addPersistedAnimal(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_addPersistedAnimalParameterTypes1);
	...
	public static com.liferay.model.PersistedAnimal deletePersistedAnimal(
			HttpPrincipal httpPrincipal, int animalId)
		throws com.liferay.portal.kernel.exception.PortalException {

		try {
			MethodKey methodKey = new MethodKey(
				PersistedAnimalServiceUtil.class, "deletePersistedAnimal",
				_deletePersistedAnimalParameterTypes2);
	...
	private static final Class<?>[] _addPersistedAnimalParameterTypes1 =
		new Class[] {
			String.class, String.class, int.class,
			com.liferay.portal.kernel.service.ServiceContext.class
		};
	private static final Class<?>[] _deletePersistedAnimalParameterTypes2 =
		new Class[] {int.class};
