...
/**
 * The persistence interface for the persisted animal service.
 *
 * <p>
 ...
 * @see PersistedAnimalUtil
 * @generated
 */
@ProviderType
public interface PersistedAnimalPersistence
	extends BasePersistence<PersistedAnimal> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PersistedAnimalUtil} to access the persisted animal persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public java.util.List<PersistedAnimal> findByUuid(String uuid);
	 ...
	 */
	public java.util.List<PersistedAnimal> findByUuid(
	...
	public java.util.List<PersistedAnimal> findByUuid(
		String uuid, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<PersistedAnimal>
			orderByComparator);
	 ...
	 * @return the matching persisted animals
	 */
	public java.util.List<PersistedAnimal> findByUuid_C(
	 ...
	 */
	public void cacheResult(java.util.List<PersistedAnimal> persistedAnimals);
	 ...
	 */
	public java.util.List<PersistedAnimal> findAll();
	 ...
	 */
	public java.util.List<PersistedAnimal> findAll(int start, int end);
